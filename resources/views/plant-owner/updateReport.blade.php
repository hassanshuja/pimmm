...
@section('content')
    ...
    <div class="own-report">
        <form action="/updateEquipmentOwner/{{$job->id}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="box">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab-report"onclick="hidesaveReportJob()" data-toggle="tab">Equip List & Reports</a></li>

                    <li><a href="#tab-data" data-toggle="tab" onclick="hidesaveReportJob()">Equip Data Sheets</a></li>
                    <li><a href="#notes" data-toggle="tab" onclick="showsaveReportJob()">Notes</a></li>
                    <li><a href="#new" data-toggle="tab"onclick="showsaveReportJob()">New/Existing Repair Jobs</a></li>
                    <li><a href="#loc" data-toggle="tab" onclick="showsaveReportJob()">Equip Location</a></li>
                    <li><a href="#loop" data-toggle="tab"onclick="showsaveReportJob()">Equip Links/Loops</a></li>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tag_number"
                                                   placeholder="tag_number" value="{{$general->tag_number}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop1" name="unit_vessel" class="form-control small-box" >
                                                <option value="{{$general->unit_vessel}}" selected>{{$general->unit_vessel}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop2" name="name" class="form-control small-box" >
                                                <option value="{{$general->name}}" selected>{{$general->name}}</option>
                                                <option value="#1 Compressor">#1 Compressor</option>
                                                <option value="#2 Compressor" >#2 Compressor</option>
                                                <option value="Glycol Filter" >Glycol Filter</option>
                                                <option value="Glycol Pump" >Glycol Pump</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop3" name="status" class="form-control small-box" >
                                                <option value="{{$general->status}}" selected>{{$general->status}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop4" name="universal1" class="form-control small-box" >
                                                <option value="{{$general->universal1}}" selected>{{$general->universal1}}</option>
                                                <option>Active</option>
                                                <option>Inactive</option>
                                                <option>Spare</option>
                                                <option>Junk</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="model_number" class="form-control" name="model_number"
                                                   placeholder="model_number" value="{{$general->model_nuber}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nb_registration"
                                                   placeholder="nb_registration" value="{{$general->nb_registration}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop5" name="sizing_text" class="form-control small-box" >
                                                <option value="{{$general->sizing_text}}" selected>{{$general->sizing_text}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="purchase_price"
                                                   placeholder="purshase price" value="{{$general->purchase_price}}" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="service" class="form-control small-box" >
                                                <option value="{{$general->service}}" selected>{{$general->service}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="code_stamp" id="drop7" class="form-control small-box" >
                                                <option value="{{$general->code_stamp}}" selected>{{$general->code_stamp}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="serial_number"
                                                   placeholder="serial number" value="{{$general->serial_number}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop8" class="form-control small-box" name="device_type">
                                                <option value="{{$general->device_type}}" selected>{{$general->device_type}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop9" class="form-control small-box" name="equipment_location">
                                                <option value="{{$general->equipment_location}}" selected>{{$general->equipment_location}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop10" class="form-control small-box" name="equipment_link">
                                                <option value="{{$general->equipment_link}}" selected>{{$general->equipment_link}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop11" class="form-control small-box" name="job_number">
                                                <option value="{{$general->job_number}}" selected>{{$general->job_number}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop12" name="manufacturer" class="form-control small-box">
                                                <option value="{{$general->manufacturer}}" selected>{{$general->manufacturer}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="registration"
                                                   placeholder="registration" value="{{$general->registration}}" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop13" class="form-control small-box" name="universal2">
                                                <option value="{{$general->universal2}}" selected>{{$general->universal2}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop14" class="form-control small-box" name="risk">
                                                <option value="{{$general->risk}}" selected>{{$general->risk}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop15" class="form-control small-box" name="product">
                                                <option value="{{$general->product}}" selected>{{$general->product}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop16" class="form-control small-box" name="code_required">
                                                <option value="{{$general->code_required}}" selected>{{$general->code_required}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="capacity"
                                                   placeholder="capacity" value="{{$general->capacity}}" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control">{{$general->description}}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop17" class="form-control small-box" name="inlet_rating1">
                                                <option value="{{$valve->inlet_rating}}" selected>{{$valve->inlet_rating}}</option>
                                                <option>150#</option>
                                                <option>300#</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop18" class="form-control small-box" name="inlet_facing1">
                                                <option value="{{$valve->inlet_facing}}" selected>{{$valve->inlet_facing}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop19" class="form-control small-box" name="inlet_other1">
                                                <option value="{{$valve->inlet_other}}" selected>{{$valve->inlet_other}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop20" class="form-control small-box" name="soft_seat_mat11">
                                                <option value="{{$valve->soft_seat_mat1}}" selected>{{$valve->soft_seat_mat1}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop21" class="form-control small-box" name="body_material1">
                                                <option value="{{$valve->body_material}}" selected>{{$valve->body_material}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop22" class="form-control small-box" name="trim_material1">
                                                <option value="{{$valve->trim_material}}" selected>{{$valve->trim_material}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop23" class="form-control small-box" name="spring_material1">
                                                <option value="{{$valve->spring_material}}" selected>{{$valve->spring_material}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop24" class="form-control small-box" name="style1">
                                                <option value="{{$valve->style}}" selected>{{$valve->style}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop25" class="form-control small-box" name="traveller1">
                                                <option value="{{$valve->traveller}}" selected>{{$valve->traveller}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop26" class="form-control small-box" name="orifice_designation1">
                                                <option value="{{$valve->orifice_designation}}" selected>{{$valve->orifice_designation}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop27" class="form-control small-box" name="outlet_rating1">
                                                <option value="{{$valve->outlet_rating}}" selected>{{$valve->outlet_rating}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop28" class="form-control small-box" name="outlet_facing1">
                                                <option value="{{$valve->outlet_facing}}" selected>{{$valve->outlet_facing}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop29" class="form-control small-box" name="outlet_other1">
                                                <option value="{{$valve->outlet_other}}" selected>{{$valve->outlet_other}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop30" class="form-control small-box" name="bonnet_material1">
                                                <option value="{{$valve->bonnet_material1}}" selected>{{$valve->bonnet_material}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select  id="31" class="form-control small-box" name="bellows_material1">
                                                <option value="{{$valve->bellows_material}}" selected>{{$valve->bellows_material}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop32" class="form-control small-box" name="bonnet1">
                                                <option value="{{$valve->bonnet}}" selected>{{$valve->bonnet}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop33" class="form-control small-box" name="cap_type1">
                                                <option value="{{$valve->cap_type}}" selected>{{$valve->cap_type}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"value="{{$valve->area}}" name="area1"  placeholder="Area"
                                            >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mawp3"value="{{$process->mawp}}" placeholder="MAWP">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="back_pressure3" value="{{$process->back_pressure}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="asme_capacity3"value="{{$process->asme_capacity3}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop34" class="form-control small-box" name="3">
                                                <option value="{{$process->required}}" selected> {{$process->required}}</option>
                                                <option>None</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop35" class="form-control small-box" name="blow_down3">
                                                <option value="{{$process->blow_down}}" selected> {{$process->blow_down}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="capacity23"
                                                   placeholder="Capacity" value="{{$process->capacity2}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="model_number23"
                                                   placeholder="Prev Require Company" value="{{$process->model_number2}}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop36" class="form-control small-box" name="received_by5">
                                                <option value="{{$parts->received_by}}">{{$parts->received_by}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop37" class="form-control small-box" name="universal5">
                                                <option value="{{$parts->universal}}">{{$parts->universal}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop38" class="form-control small-box" name="dismb5">
                                                <option value="{{$parts->dismb5}}">{{$parts->dismb}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop39" class="form-control small-box" name="for5">
                                                <option value="{{$parts->for}}">{{$parts->for}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="date5" value="{{$parts->date}}" placeholder="due date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop40" class="form-control small-box" name="prepop_reason5">
                                                <option value="{{$parts->prepop_reason}}">{{$parts->prepop_reason}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop41" class="form-control" name="prepop_reason25">
                                                <option value="{{$parts->prepop_reason2}}">{{$parts->prepop_reason2}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop42" class="form-control small-box" name="leak_test5">
                                                <option value="{{$parts->leak_test5}}">{{$parts->leak_test}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$parts->option}}" name="option5" placeholder="@">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="comp_screw_recd5"
                                                   placeholder="Comp Screw Recd" value="{{$parts->comp_screw_recd}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control small-box" name="nameplate5">
                                                <option value="{{$parts->nameplate}}">{{$parts->nameplate}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop43"class="form-control small-box" name="seal5">
                                                <option value="{{$parts->seal}}">{{$parts->seal}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="44" class="form-control small-box" name="seal_id5">
                                                <option value="{{$parts->seal_id}}">{{$parts->seal_id}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="45" class="form-control small-box" name="prev_repair_compant5">
                                                <option value="{{$parts->prev_repair_compant}}">{{$parts->prev_repair_compant}}</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop46" class="form-control" name="repair_company4">
                                                <option value="{{$test->repair_company}}">{{$test->repair_company}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="47" class="form-control small-box" name="assembled_by4">
                                                <option value="{{$test->assembled_by}}">{{$test->assembled_by}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop48" class="form-control small-box" name="test_media4">
                                                <option value="{{$test->test_media}}">{{$test->test_media}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop49" class="form-control small-box" name="test_method4">
                                                <option value="{{$test->test_method}}">{{$test->test_method}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$test->gaug}}" name="gauge14" placeholder="Gaug 1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop50" class="form-control small-box" name="test_univ24">
                                                <option value="{{$test->test_univ2}}">{{$test->test_univ2}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="drop51" class="form-control small-box" name="test_by4">
                                                @foreach($users as $user)
                                                    @if($test->test_by==$user->first_name.''.$user->last_name)
                                                        <option value="{{$user->first_name.''.$user->last_name}}" selected>{{$user->first_name.''.$user->last_name}}</option>
                                                                     @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop52" class="form-control small-box" name="witnessed_by4">
                                                <option value="{{$test->witnessed_by}}">{{$test->witnessed_by}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="gauge24" value="{{$test->gaug2}}" placeholder="Gaug 2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="blow_down4"
                                                   placeholder="Blow Down" value="{{$test->blow_down4}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop53" class="form-control small-box" name="ring_up4">
                                                <option value="{{$test->ring_up}}">{{$test->ring_up}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop54" class="form-control small-box" name="for4">
                                                <option value="{{$test->for}}">{{$test->for}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop55" class="form-control small-box" name="leaking_reate4">
                                                <option value="{{$test->leaking_reate}}">{{$test->leaking_reate}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">@</label>
                                            <input type="text" class="form-control" value="{{$test->option1}}" name="option14" placeholder="@">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop56" class="form-control small-box" name="back_press_test4">
                                                <option value="{{$test->back_press_test}}">{{$test->back_press_test}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">@</label>
                                            <input type="text" class="form-control"  value="{{$test->option2}}"  name="option24" placeholder="@">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="drop57" class="form-control small-box" name="bd_ring4">
                                                <option value="{{$test->bd_ring}}">{{$test->bd_ring}}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="next_main_date4"
                                                   placeholder="Next Maint Date" value="{{$test->next_main_date4}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="manufactuers26"
                                                   placeholder="manufacturers Min/Max" value="{{$critical->manufactuers26}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="manufactuers76"
                                                   placeholder="manufacturers Min/Max" value="{{$critical->manufactuers76}}">
                            ...
                            <div class="tab-pane" id="tab-seven">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Undef Equip</label>$cost
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Undef Equip</label>
                                            <input type="text" class="form-control" name="equipment4"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="equipment15"
                                                   placeholder="measured" value="{{$cost->equipmen5}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="note"  class="form-control">{{$job->note}}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_number_"
                                           placeholder="total_repair_cost" value="{{$job->jobnumber}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="estimated_by"
                                           placeholder="total_repair_cost" value="{{$job->estimatedby}}" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="job_date"
                                           placeholder="total_repair_cost" value="{{$job->jobdate}}" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="invoice_date" placeholder="invoicedate"value="{{$job->invoicedate}}"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Note</label>
                                    <textarea name="note2" class="form-control">{{$job->note2}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_equipment_type"value="{{$job->equipment_type}}"  placeholder="job_equipment_type"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_location_uni1"value="{{$job->location_uni1}}"  placeholder="job_location_uni1"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_location_uni2"value="{{$job->location_uni2}}"  placeholder="job_location_uni1"
                                    >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_link_name"value="{{$job->link_name}}"  placeholder="job_link_name"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_link_uni1" value="{{$job->link_uni1}}" placeholder="date"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_link_uni2"value="{{$job->link_uni2}}"  placeholder="date"
                                    >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_link_uni3"value="{{$job->link_uni3}}"  placeholder="date"
                                    >
            ...
            <input type="submit" name="addjob" id="saveReportJob" value="Save Report" style="display: none">
                    ...
                    <div class="main-area">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Tag Number</label>
                                    <input type="text" name="part_tag" value="{{$part->tag_number}}" id="part_tag" class="form-control" placeholder="Tag Number" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Equipment Type</label>
                                    <input type="text" name="part_equipment_type" id="part_equipment_type"value="{{$part->equipment_type}} class="form-control" value="{{$part->equipment_type}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="part_price" id="part_price" value="{{$part->price}}class="form-control small" value="{{$part->price}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Quantity</label>
                                    <input type="number"name="part_quantity" id="part_quantity"value="{{$part->quantity}} class="form-control small" value="{{$part->quantity}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="part_cost" id="part_cost" value="{{$part->cost}}class="form-control small" value="{{$part->cost}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="part_deliver" id="part_deliver"value="{{$part->deliver_date}}" type="date" class="form-control small" value="{{$part->delivery_date}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <button type="button" onclick="savepart('{{$part->id}}')">Save</button>
                                </div>
                            </div>
    ...
    <script>
        function hidesaveReportJob() {
            $('#saveReportJob').hide();
        }
    </script>
    <script>
        function showsaveReportJob() {
            $('#saveReportJob').show();
        }
    </script>
    <script>
