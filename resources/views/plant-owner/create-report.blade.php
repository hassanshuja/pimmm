                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="spring_number1"
                                                   placeholder="spring number" value="">

                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Spring Material</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="config_univ21"
                                                   placeholder="config unit2" value="">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="drop51" class="form-control small-box" name="test_by4">
                                                ...
                                                @foreach($users as $user)
                                                    <option value="{{ $user->company_name }}"
                                                            @if(isset($test->test_by) && $test->test_by == "{{ $user->company_name }}") selected @endif>{{$user->first_name.''.$user->last_name}}</option>
                                                @endforeach
                                            </select><a href="#" class="small-box-a">...</a>
                                            <div class="small-box-a">...
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="finial_test4"
                                                   placeholder="Final Test Press" value="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="reset_press4"
                                                   placeholder="Reseat Press" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="measured_lift4"
                                                   placeholder="Measured Lift" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="next_maint_is4" value="Unscheduled">Unscheduled
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="replace_valve_next4" value="Scheduled">Scheduled
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="over_lap4"
                                                   placeholder="Overlap Collar" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="handing_cost2"
                                                   placeholder="handing costs" value="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="qc_inspector2"
                                                   placeholder="QC Inspector" value="">
...
{{--                                            @if($Equipmentimage)--}}
{{--                                                <img src="/" alt="Equipment Image" style="width:250px">--}}
{{--                                            @endif--}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="estimated_by"
                                           placeholder="estimated_by" value="">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="job_location_name"
                                           value="" placeholder="location_name"
                                    >
