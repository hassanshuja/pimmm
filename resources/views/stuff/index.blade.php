                                        ...
                                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                                            ...
                                            @foreach($stuffs as $user)
                                                <tr>
                                                    ...
                                                    <td><div class="btn-group btn-group-sm" style="float: none;"><a href="{{route('stuff.edit',$user->id)}}" class="btn btn-warning" >Edit</a> <form class="myform" id="{{$user->id}}"  method="post"  action="{{(route('stuff.destroy',$user->id))}}">   @csrf
