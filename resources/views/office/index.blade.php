                                                ...
                                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                    ...
                                                    @foreach($offices as $office)
                                                        <tr>
                                                            ...
                                                            <td>{{$office->name}}</td>
                                                            <td>{{$office->user->first_name.' '.$office->user->last_name}}</td>
                                                            <td><a href="/editOffice/{{$office->id}}"/>edit</td>
                                                            <td><a href="/deleteOffice/{{$office->id}}"/>delete</td>
                                                            {{--<td><form class="myform" id="{{$office->id}}"  method="post"  action="{{url('/deleteOffice/'.$office->id)}}">   @csrf--}}
                                                                    {{--{!! method_field('Delete') !!}<button type="submit" class="btn btn-danger" >Delete </button></form></td>--}}
                                                        </tr>
                                                    @endforeach
