            ...
            <div class="tbl">
                <div class="tbl-row">
                    ...
                    <div class="tbl-cell hdr-logo">
                        <a href="/home_ar"><img src="/images/logo1.png" alt=""></a>
                    ...
                    <div class="tbl-cell hdr-menu">
                        ...
                        <ul class="menu">
                            @foreach($menus as $menu)
                                @if($menu->type==1)
                                    <li>
                                        <a id="menu-home" class="mdl-button mdl-js-button mdl-js-ripple-effect">{{$menu->name_arabic}} <i class="fa fa-chevron-down"></i></a>
                                        <ul class="menu-dropdown">
                                            @foreach($menu->pages as $paged)
                                                <li><a href="/page_ar/{{$paged->id}}">{{$paged->name_arabic}}</a></li>
                                            @endforeach
                                ...
                                @if($menu->type==2)
                                    <li class="menu-megamenu-li">
                                        <a id="menu-pages" class="mdl-button mdl-js-button mdl-js-ripple-effect">{{$menu->name_arabic}} <i class="fa fa-chevron-down"></i></a>
                                                ...
                                                @foreach($menu->branches as $branch)
                                                    ...
                                                    @if($index==0 || $index % 2 == 0)
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <ul>
                                                                <div class="megamenu-ttl">{{$branch->name_arabic}}</div>
                                                                @foreach($branch->pages as $paged)
                                                                    <li><a href="/page/{{$paged->id}}">{{$paged->name_arabic}}</a></li>
                                                                @endforeach
                    ...
                    @foreach($pages as $paged)
                        <li><a href="/page_ar/{{$paged->id}}" id="menu-shortcodes" class="mdl-button mdl-js-button mdl-js-ripple-effect">{{$paged->name_arabic}}</a></li>

                    @endforeach

                    <li><a href="/about_us_ar" id="menu-shortcodes" class="mdl-button mdl-js-button mdl-js-ripple-effect">من نحن</a></li>
                    <li><a href="/contact_us_ar" id="menu-shortcodes" class="mdl-button mdl-js-button mdl-js-ripple-effect">اتصل بنا</a></li>
