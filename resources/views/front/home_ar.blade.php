...
@section('header')
    <a href="/home" class="lange"> English</a>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="theme-block">
                            ...
                            <div class="theme-block-data service-block-data">
                                ...
                                <h4><a href="inner-pager.html">{{$homes[$i]->name_arabic}}</a></h4>
                            </div>
                            <div class="theme-block-hidden service-hidden-block">
                                <i class="fa fa-stethoscope"></i>
                                <h4><a  href="/page/{{$homes[$i]->id}}">{{$homes[$i]->name_arabic}}</a></h4>
                                <p class="service-description paragraph-small paragraph-black">
                                    <span> {{$homes[$i]->description_arabic}}
                                    </span>
