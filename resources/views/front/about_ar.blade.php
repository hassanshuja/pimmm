...
@section('header')
    <a href="/about_us" class="lange"> English</a>
                        ...
                        @foreach($presses as $press)
                            <a href="https://{{$press->url}}" target="_blank" class="row blog-recent">
                                ...
                                <div class="col-8 blog-recent-post">
                                    <h4>{{$press->title_arabic}}</h4>
                                    <p>{{$press->description_arabic}}
                    ...
                    <div class="theme-material-card">
                        ...
                        <ul class="category-list">
                            @foreach($clients as $client)
                                <li><a href="#"><i class="fa fa-info-circle"></i>{{$client->name_arabic}}</a><span>({{$client->number}})</span></li>
                            @endforeach
                        </ul>
                    </div>
