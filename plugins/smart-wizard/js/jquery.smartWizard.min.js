...
!function (t, s, e, n) {
    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            return this.options.cycleSteps || (0 >= s ? t(".sw-btn-prev", this.main).addClass("disabled") : t(".sw-btn-prev", this.main).removeClass("disabled"), this.steps.length - 1 <= s ? t(".sw-btn-next", this.main).addClass("hidden") : t(".sw-btn-next", this.main).removeClass("hidden")), !0
        }, _keyNav: function (t) {
            var s = this;
            switch (t.which) {
                case 37:
